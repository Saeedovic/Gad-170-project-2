...
public class CharacterNameGenerator : ScriptableObject
{
    ...
    public CharacterName[] GenerateNames(int namesNeeded)
    {
        ...
        for (int i = 0; i < names.Length; i++)
        {
            ...
            CharacterName Saeed = new CharacterName(firstNames[randomFirstNameNumber], lastNames[randomLastNameNumber], nicknames[randomNickNameNumber], descriptors[randomDescriptorNameNumber]);
            names[i] = Saeed;
